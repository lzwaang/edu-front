              ...
              <li v-for="item in data.courseList" :key="item.id">
                ...
                <el-card class="box-card" shadow="hover">
                  ...
                  <el-row>
                    ...
                    <el-button type="primary" round @click="location='/course/'+item.id">课件学习</el-button>
                    <router-link :to="'/course/'+item.id">
                      <el-button type="primary" round @click="location='/course/'+item.id">视频学习</el-button>
                    </router-link>
...
export default {
  ...
  methods:{
    ...
    getCourseList(current = 1) {
      ...
      courseApi.getCourseList(this.current,8,this.courseFrontQuery).then(response => {
